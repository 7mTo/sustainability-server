...
test('short capture', function (t) {
    t.same(
        optimist.parse([ '-h', '10.254.144.101' ]),
        { h : '10.254.144.101', _ : [], $0 : $0 }
    );
    t.end();
});
...
test('short captures', function (t) {
    t.same(
        optimist.parse([ '-h', '10.254.144.101', '-p', '555' ]),
        { h : '10.254.144.101', p : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('long captures sp', function (t) {
    t.same(
        optimist.parse([ '--host', '10.254.144.101', '--port', '555' ]),
        { host : '10.254.144.101', port : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('mixed short bool and capture', function (t) {
    t.same(
        optimist.parse([ '-h', '10.254.144.101', '-fp', '555', 'script.js' ]),
        {
            f : true, p : 555, h : '10.254.144.101',
            _ : [ 'script.js' ], $0 : $0,
        }
    );
    t.end();
